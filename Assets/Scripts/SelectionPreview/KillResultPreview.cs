...
{
    public class KillResultPreview : MonoBehaviour {

        private float _initialY;
        private float _initialWidth;
        private float _initialHeight;

        public static KillResultPreview Instance;
        ...
        void OnUpdate(IDictionary<AttackResult, decimal> attackResults)
        {
            ...
            GetComponent<RectTransform>().sizeDelta = new Vector2(_initialWidth * 4 * (float)attackResults[AttackResult.Kill], _initialHeight);
